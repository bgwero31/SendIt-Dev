        ...
        <div className="relative z-10">
          ...
          <div className="mt-5">
            ...
            <p className="mt-1 text-[13px] text-white/80">
              Send your script to the pharmacy for medicine review and confirmation.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid gap-5 xl:grid-cols-[1.15fr_0.85fr]">
          <div className="space-y-5">
              ...
              <div className="mb-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[12px] text-neutral-500">
                    Who should review this prescription
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-[28px] bg-white p-5 shadow-[0_12px_34px_rgba(0,0,0,0.08)]">
              <div className="mb-4 flex items-start gap-3">
                <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#eef4ff]">
                  <Upload className="h-5 w-5 text-[#173ea5]" />
                </div>
                <div>
                  <p className="text-[16px] font-semibold text-neutral-900">
                    Prescription file
                  ...
                  <p className="mt-1 text-[12px] text-neutral-500">
                    Upload script image or PDF later
                  </p>
                </div>
              </div>
              ...
              {form.fileName ? (
                <div className="mt-4 rounded-[18px] bg-[#f8fafc] px-4 py-3">
                  <p className="text-[11px] text-neutral-500">Selected file</p>
            ...
            <div className="rounded-[28px] bg-white p-5 shadow-[0_12px_34px_rgba(0,0,0,0.08)]">
              <div className="mb-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[12px] text-neutral-500">
                    Add medicine names or extra notes
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Add delivery note, urgent request, or pharmacist message..."
                    className="w-full rounded-[18px] border border-neutral-200 bg-[#f8fafc] px-4 py-3 text-[13px] outline-none"
                  />
                </div>
              </div>
          ...
          <div className="space-y-5">
            <div className="rounded-[28px] bg-white p-5 shadow-[0_12px_34px_rgba(0,0,0,0.08)] xl:sticky xl:top-5">
              ...
              <div className="mt-4 space-y-3">
                ...
                <div className="rounded-[18px] bg-[#f8fafc] px-4 py-3">
                  <p className="text-[11px] text-neutral-500">Prescription file</p>
                  <p className="mt-1 text-[13px] font-semibold text-neutral-900">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-[11px] leading-5 text-neutral-500">
                      Later this will send the script to pharmacy staff for approval and stock confirmation.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 rounded-[22px] border border-neutral-200 p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-[11px] leading-5 text-neutral-500">
                      Prescription items should stay under pharmacist review before checkout.
                    </p>
                  </div>
                </div>
              </div>
